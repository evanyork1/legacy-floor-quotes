          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <img src="/lovable-uploads/4a736b12-2872-4f73-9c03-1fe5a79358d9.png" alt="Legacy Industrial Coatings professional truck and equipment ready for service" className="rounded-2xl shadow-2xl w-full h-auto" / loading="lazy" decoding="async" >
              </div>
            </div>
          </div>
        </section>
