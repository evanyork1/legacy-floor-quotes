          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <img src="/lovable-uploads/7b59a18f-94c1-45aa-88f1-9bc7c3277305.png" alt="Beautiful polyurea flake patio installation" className="relative w-full h-96 object-cover rounded-2xl shadow-2xl" / loading="lazy" decoding="async" >
              </div>
            </div>
          </div>
        </section>
