      ...
      <div className="min-h-screen bg-white print:min-h-0">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 print:py-4">
          ...
          <div className="mb-8 print:mb-6">
            <h1 className="text-3xl font-bold text-navy-900 text-center mb-6 print:text-2xl print:mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 print:gap-4">
            {packages.map((pkg) => (
              <Card 
                key={pkg.name} 
                className={`relative border-2 print:border ${
                  pkg.popular 
                    ? 'border-navy-500 ring-2 ring-navy-200 shadow-xl scale-105 print:scale-100' 
                    : 'border-navy-200'
                } print:shadow-none print:ring-0`}
              >
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 print:-top-2">
                ...
                <CardHeader className="text-center pb-4 print:pb-2">
                  <CardTitle className={`text-2xl font-bold print:text-xl ${
                    pkg.popular ? 'text-navy-600' : 'text-navy-900'
                  }`}>
                    {pkg.name}
                  </CardTitle>
                </CardHeader>
