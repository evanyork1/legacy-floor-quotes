          ...
          <div className="absolute inset-0 z-20 flex items-center">
            <div className="container mx-auto px-4">
              <div className="max-w-2xl">
                ...
                <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-100 mb-6">
                  ...
                  <span className="text-sm font-medium text-gray-700">180+ Google Reviews</span>
                </div>
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex flex-col items-center mt-3 ml-4">
                    ...
                    <span className="text-white text-sm font-medium mt-1">Get a quote in 60 seconds</span>
                  </div>
                </div>
              </div>
            </div>
