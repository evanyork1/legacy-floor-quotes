...
import { Menu, X, Clock, MapPin, Shield, Award, Wrench, CheckCircle, ArrowLeft } from "lucide-react";
...
const services = [
  ...
  { title: "Floor Densification", description: "Lithium silicate densifiers penetrate and harden concrete, increasing abrasion resistance and extending the life of your polished floor." },
    ...
    <div className="min-h-screen bg-[hsl(0,0%,5%)] text-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Polished commercial concrete floor" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-r from-[hsl(0,0%,5%)]/90 via-[hsl(0,0%,5%)]/70 to-[hsl(0,0%,5%)]/30" />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 py-32">
          <div className="max-w-3xl">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="mt-8 text-lg md:text-xl text-white/70 max-w-xl leading-relaxed font-light">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <div className="aspect-[4/3] overflow-hidden">
                <img src={polishingImage} alt="Concrete polishing in action" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" />
              </div>
            </motion.div>
      ...
      {/* ─── Why Legacy ─── */}
      <section id="why" className="py-24 md:py-32 bg-[hsl(0,0%,8%)]">
        <div className="container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <div className="w-12 h-[2px] bg-blue-500 mx-auto mb-6" />
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10">
            {reasons.map((reason, i) => (
              <motion.div key={reason.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }} className="bg-[hsl(0,0%,8%)] p-8 group">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <p className="mt-6 text-white/60 text-lg leading-relaxed max-w-md">
                Whether you need 5,000 sq ft or 500,000 sq ft — we bring the same precision, speed, and standards to every job. Tell us about your project.
              </p>
              <div className="mt-8 space-y-4 text-sm">
                <div className="flex items-center gap-3">
                  <span className="text-blue-400 font-semibold uppercase tracking-wider">Phone</span>
                  <span className="text-white/60">(940) 390-2680</span>
                </div>
                <div className="flex items-center gap-3">
