...
import baseboardFlake from "@/assets/aquatots-baseboard-flake.webp";
import bathroom from "@/assets/aquatots-bathroom.jpg";
import lobby from "@/assets/aquatots-lobby.jpg";
import completed1 from "@/assets/aquatots-completed-1.webp";
import completed2 from "@/assets/aquatots-completed-2.webp";
import completed3 from "@/assets/aquatots-completed-3.webp";
import completed4 from "@/assets/aquatots-completed-4.webp";
import moldSpores from "@/assets/aquatots-mold-spores.png";
import wetDebris from "@/assets/aquatots-wet-debris.png";
import horrorCircled from "@/assets/aquatots-horror-circled.webp";
import horror2 from "@/assets/aquatots-horror-2.webp";
import horror3 from "@/assets/aquatots-horror-3.webp";
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 lg:py-24">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center mb-10">
                <img src={aquatotsLogo} alt="Aqua-Tots Swim Schools" className="h-16 sm:h-24 w-auto" / loading="lazy" decoding="async" >
              </div>
