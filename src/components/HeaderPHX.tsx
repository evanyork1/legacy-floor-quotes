...
const HeaderPHX = () => {
  ...
  // Force PHX context for this header
  const isPHX = true;
  
  // Always use PHX paths
  const quotePath = '/quotephx';
  const homePath = '/phx';
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <div className="px-4 pt-2">
                <Button 
                  ...
                  onClick={handlePhoneClick}
                >
                  <a href="tel:602-560-0974" onClick={() => setIsMenuOpen(false)}>
                    <Phone className="mr-2 h-4 w-4" />
                    602-560-0974
                  </a>
                </Button>
