  ...
  return (
    <footer className="bg-slate-800 text-white py-16 sm:py-20 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-1 lg:gap-1 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                ...
                <a href="mailto:support@legacyindustrialcoatings.com" className="text-gray-300 hover:text-blue-400 transition-colors text-xs break-all">
