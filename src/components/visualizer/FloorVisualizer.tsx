            ...
            <Card className="border-navy-200 sticky top-4 relative">
              ...
              {transformedImage && <div className="px-6 pb-6">
                  <div className="max-w-md mx-auto">
                    <Button size="lg" onClick={() => setShowQuoteModal(true)} className="w-full bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 hover:from-blue-700 hover:via-blue-800 hover:to-blue-900 text-white py-7 px-8 text-xl font-bold shadow-xl hover:shadow-2xl border-2 border-blue-500 transform hover:scale-105 transition-all duration-200">
