...
const HeroSection = ({
  ...
  return <section className="relative bg-gradient-to-br from-slate-50 via-blue-50/30 to-white py-20 sm:py-24 lg:py-28 overflow-hidden">
          ...
          <div className="max-w-2xl space-y-4 lg:space-y-6">
            ...
            <div className="relative pt-2">
              <div className="flex flex-col sm:flex-row gap-4">
                <Button onClick={() => navigate(isDFW ? '/quotedfw' : '/quote')} className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-lg lg:text-xl px-10 lg:px-12 py-5 lg:py-6 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
                  Get Instant Quote
                  <ArrowRight className="ml-3 h-5 w-5 lg:h-6 lg:w-6" />
                </Button>
                {isDFW && <Button size="lg" variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-4 text-lg" onClick={() => window.open('tel:214-305-6516', '_self')}>
                    Call (214) 305-6516
                  </Button>}
              </div>
            </div>
