    ...
    return (
      <section className="relative overflow-hidden">
        ...
        <Button
          ...
          className={`fixed right-[-130px] top-1/2 transform -translate-y-1/2 -rotate-90 origin-center font-bold px-5 py-6 text-lg shadow-2xl z-50 rounded-l-xl rounded-r-none border-3 transition-all duration-300 ${
            scrolledPastHero 
