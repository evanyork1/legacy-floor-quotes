        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {steps.map((step, index) => (
            <div key={index} className="text-center group">
              <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-blue-900 text-white flex items-center justify-center text-lg sm:text-xl font-bold mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {step.step}
              </div>
