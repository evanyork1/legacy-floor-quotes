...
export const products: Product[] = [
  {
    ...
    metaDescription: "Resinous floor systems installed across DFW: high-build epoxy, self-leveling, urethane, flake, and quartz broadcast. Spec'd to your loads, chemicals, and downtime window.",
    heroImage: heroEpoxy,
