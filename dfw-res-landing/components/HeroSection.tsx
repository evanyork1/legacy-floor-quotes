...
const HeroSection = () => {
  ...
  const title = "DFW's Epoxy Flooring";
  const subtext = "Residential & Commercial Floor Coatings That Last";
      ...
      <div className="container mx-auto px-6 lg:px-8 relative w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative">
            <img 
              src="/assets/lovable-uploads/e90dc902-382c-49a1-92b3-46b9b06b6a4b.png" 
